Esta aplicación Android muestra una lista de personajes de la serie Rick y Morty, utilizando la API Rick y Morty. La aplicación está construida con las siguientes tecnologías:
